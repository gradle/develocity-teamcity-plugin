...
import com.gradle.develocity.teamcity.agent.maven.testutils.MavenInstaller
import com.gradle.develocity.teamcity.agent.maven.testutils.MavenProject
import com.gradle.develocity.teamcity.agent.maven.testutils.MavenRunner
...
abstract class BaseExtensionApplicationTest extends Specification {
    ...
    static final String DEVELOCITY_EXTENSION_VERSION = '2.0.1'
    static final String CCUD_EXTENSION_VERSION = '2.0.3'
