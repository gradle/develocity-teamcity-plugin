...
import com.gradle.develocity.teamcity.agent.TestBuildRunnerContext
import com.gradle.develocity.teamcity.agent.gradle.testutils.TestBuildScanServiceMessageInjector
...
import static com.gradle.develocity.teamcity.agent.BuildScanServiceMessageInjector.BUILD_SCAN_INIT_GRADLE
...
class BaseInitScriptTest extends Specification {
    ...
    static final JdkCompatibleGradleVersion GRADLE_8_X = new JdkCompatibleGradleVersion(GradleVersion.version('8.14.2'), 8, 21)
    ...
    static final String CCUD_PLUGIN_VERSION = '2.3'
