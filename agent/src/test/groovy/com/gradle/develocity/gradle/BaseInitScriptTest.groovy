...
import com.gradle.develocity.BuildScanServiceMessageInjector
import com.gradle.develocity.ExtensionApplicationListener
import com.gradle.develocity.TcPluginConfig
import com.gradle.develocity.TestBuildRunnerContext
import com.gradle.develocity.gradle.testutils.TestBuildScanServiceMessageInjector
...
import static com.gradle.develocity.BuildScanServiceMessageInjector.BUILD_SCAN_INIT_GRADLE
...
class BaseInitScriptTest extends Specification {
    ...
    void outputContainsTeamCityServiceMessageBuildScanUrl(BuildResult result) {
        def serviceMsg = "##teamcity[com.gradle.develocity.buildScanLifeCycle 'BUILD_SCAN_URL:${mockScansServer.address}s/$PUBLIC_BUILD_SCAN_ID']"
        assert result.output.contains(serviceMsg)
        assert 1 == result.output.count(serviceMsg)
    }
    ...
    private static List<String> mapEnvVarsToSystemProps(Map<String, String> envVars) {
        def mapping = [
            TEAMCITYDEVELOCITYPLUGIN_DEVELOCITY_URL                     : "teamCityDevelocityPlugin.develocity.url",
            TEAMCITYDEVELOCITYPLUGIN_DEVELOCITY_ALLOW_UNTRUSTED_SERVER  : "teamCityDevelocityPlugin.develocity.allow-untrusted-server",
            TEAMCITYDEVELOCITYPLUGIN_DEVELOCITY_ENFORCE_URL             : "teamCityDevelocityPlugin.develocity.enforce-url",
            TEAMCITYDEVELOCITYPLUGIN_DEVELOCITY_PLUGIN_VERSION          : "teamCityDevelocityPlugin.develocity.plugin.version",
            TEAMCITYDEVELOCITYPLUGIN_CCUD_PLUGIN_VERSION                : "teamCityDevelocityPlugin.ccud.plugin.version",
            TEAMCITYDEVELOCITYPLUGIN_GRADLE_PLUGIN_REPOSITORY_URL       : "teamCityDevelocityPlugin.gradle.plugin-repository.url",
            TEAMCITYDEVELOCITYPLUGIN_INIT_SCRIPT_NAME                   : "teamCityDevelocityPlugin.init-script.name"
        ]
