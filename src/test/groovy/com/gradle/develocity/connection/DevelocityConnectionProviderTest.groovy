...
import static DevelocityConnectionConstants.DEVELOCITY_ACCESS_KEY
...
class DevelocityConnectionProviderTest extends Specification {
    ...
    def "description includes value of #parameter"() {
        ...
        DEVELOCITY_URL | 'https://develocity.example.com' | 'Develocity Server URL'
        ...
        DEVELOCITY_EXTENSION_VERSION | '1.20' | 'Develocity Maven Extension Version'
        CCUD_EXTENSION_VERSION             | '1.12.5'                        | 'Common Custom User Data Maven Extension Version'
        CUSTOM_DEVELOCITY_EXTENSION_COORDINATES | 'com.company:my-develocity-extension' | 'Develocity Maven Extension Custom Coordinates'
