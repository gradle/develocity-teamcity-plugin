...
public final class DevelocityConnectionConstants {
    ...
    public static final String DEVELOCITY_ACCESS_KEY = "gradleEnterpriseAccessKey";
    ...
    public static final String DEVELOCITY_ACCESS_KEY_ENV_VAR = "env.GRADLE_ENTERPRISE_ACCESS_KEY";
